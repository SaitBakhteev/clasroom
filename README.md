...
### Шаг 2. Внутри этой папки создайте файл solution.py и вставьте в него заготовку ниже.
...
### Допишите реализацию функции union вместо pass.

### Шаг 3. В той же папке создайте файл test_solution.py и вставьте в него тесты ниже. 
### ‼️ Этот файл менять нельзя — он используется для проверки вашей работы.

```python
import unittest
from solution import union
